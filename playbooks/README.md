...
| [fabric_reconfig](./fabric_reconfig/README.md)   | Performs a live channel-config update against a running network (v1: Assembler endpoint change), split into prepare/sign/submit stages.  |
